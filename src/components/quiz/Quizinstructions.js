...
export default function Quizinstructions() {
  return (
    <Fragment>
      ...
      <div id="wallpaper">
        <div className="container">
          ...
          <div className='example'>
            <li>The game has a duration of fifteen minutes and end as soon as your time elapses</li>
      ...
      <span className='left'><Link className="Back" to="/quizer"><div className="leave">No,take me back</div></Link></span>
      <span className='right'><Link className="Forward" to="/play/quiz"><div className="continue">Okay, let's do this</div></Link></span>
      </div>
      </div>
    </Fragment>
  )
